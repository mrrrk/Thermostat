...
void View::drawFlame() {
    ...
    tft->drawBitmap(140, 32, flameRed, 32, 32, RED);
    tft->drawBitmap(140, 32, flameYellow, 32, 32, YELLOW);
}

void View::drawText(int16_t x, int16_t y, int16_t colour, String text) {
    tft->setTextSize(1);
